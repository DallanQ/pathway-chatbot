...
export default function ChatMessages(
  ...
  return (
    <div
      className="flex-1 w-full rounded-b-xl bg-white dark:bg-gray-800 p-4 shadow-xl relative overflow-y-auto"
      ref={scrollableChatContainerRef}
    >
      <div className="flex flex-col gap-5 divide-y dark:divide-gray-600">
