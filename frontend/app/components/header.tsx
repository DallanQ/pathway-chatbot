  ...
  return (
    <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
      ...
      <div className="bottom-0 left-0 mb-4 h-auto w-full from-white via-white dark:from-black dark:via-black lg:static lg:w-auto bg-none lg:mb-0">
        <p
          className="font-nunito text-xl font-bold pY-7 md:p-0 flex items-center gap-4"
        >
          ...
          {/* <Image
            ...
            priority
          /> */}
          <a href={hints} target="_blank" className="font-nunito text-sm flex gap-1 text-blue-600 visited:text-purple-600">Hints <span><ExternalLink size={16}/></span></a>
        </p>
      </div>
    </div>
  );
